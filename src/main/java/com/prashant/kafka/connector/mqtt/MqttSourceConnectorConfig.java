...
import com.prashant.kafka.connector.mqtt.sample.SimpleProcessor;
...
public class MqttSourceConnectorConfig extends AbstractConfig {
	...
	public static ConfigDef baseConfigDef() {
		return new ConfigDef()
				...
				.define(MqttSourceConstant.MQTT_SERVER_URIS, Type.STRING, "tcp://localhost:1883", Importance.HIGH,
						"mqtt server to connect to")
				.define(MqttSourceConstant.MQTT_TOPIC, Type.STRING, "#", Importance.HIGH, "mqtt server to connect to")
				.define(MqttSourceConstant.MQTT_QUALITY_OF_SERVICE, Type.INT, 1, Importance.LOW, "mqtt qos to use")
				.define(MqttSourceConstant.MQTT_SSL_CA_CERT, Type.STRING, null, Importance.LOW,
						"CA cert file to use if using ssl", "SSL", 1, ConfigDef.Width.LONG, "CA cert",
						MODE_SSL_RECOMMENDER)
				.define(MqttSourceConstant.MQTT_SSL_CERT, Type.STRING, null, Importance.LOW,
						"cert file to use if using ssl", "SSL", 2, ConfigDef.Width.LONG, "Cert", MODE_SSL_RECOMMENDER)
				.define(MqttSourceConstant.MQTT_SSL_PRIV_KEY, Type.STRING, null, Importance.LOW,
						"cert priv key to use if using ssl", "SSL", 3, ConfigDef.Width.LONG, "Key",
						MODE_SSL_RECOMMENDER)
				...
				.define(MqttSourceConstant.MESSAGE_PROCESSOR, Type.CLASS, SimpleProcessor.class, Importance.HIGH,
